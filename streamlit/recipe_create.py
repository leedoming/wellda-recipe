...
def diet_recipe(content):
    query = f"""
            ...
            2. Reflect the units of the ingredients, and substitute with diet-friendly ingredients if possible.
            3. Specify the cooking time in the steps and write steps that match the ingredients.
            4. If you can't make recipes based on Input, return each as unknown.
            5. When you write down answer, only write content about food.
            . Answer in Korean.
            </OutputRequirements>
            <Outputexample1>
            {{
...
",
                "steps": "✅ 조리법 (조리시간 20분)\n
① 실곤약은 뜨거운 물에 살짝 데치고, 물기를 빼주세요. \n
② 낙지는 깨끗이 씻은 후 적당한 크기로 잘라둡니다.\n
③ 양파와 대파는 먹기 좋은 크기로 자르고, 고추장, 고춧가루, 간장, 알룰로스, 참기름을 섞어 양념장을 만들어 주세요. \n
④ 팬에 참기름을 데우고 다진 마늘을 먼저 볶습니다.\n
⑤ 마늘향이 올라오면 양파, 낙지, 청양고추, 양념장을 넣고 잘 볶아 주세요.\n
⑥ 그릇에 물기를 뺀 실곤약을 담아 주고, 그 옆에 잘 볶아진 낙지를 담아 주세요. \n
⑦ 위에 깨소금을 솔솔 뿌려 마무리합니다.
"
            }}
            </Outputexample2>
            """
